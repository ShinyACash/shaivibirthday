...
c.setAttribute("id", "confetti-canvas");
c.setAttribute("style", "display:block;z-index:999999;pointer-events:none");
c.width = width;
c.height = height;
...
var parent = document.getElementById('garb');
...
function createDots(dotCount) {
	for (var i = 0; i < dotCount; i++) {
		...
		xVelocity = ((Math.random() * radius))/10;
		yVelocity = ((Math.random() * radius))/10;
		fillColor = 'white';
		shadowBlur = 10;
		shadowColor = 'white';
